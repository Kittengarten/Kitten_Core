...
var (
	p224GG     *[96]fiat.P224Element
	p224GGOnce sync.Once
)
...
func p224SqrtCandidate(r, x *fiat.P224Element) {
	...
	//	return     x96 << 31 + x31
	//
	t0 := new(fiat.P224Element)
	t1 := new(fiat.P224Element)
	...
	p224MinusOne := new(fiat.P224Element).Sub(
